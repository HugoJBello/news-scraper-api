...
import { GlobalConfigSql, globalConfigSqlAttributes } from '../api/models/GlobalConfigSql';
import { NewScrapedSql, newScrapedSqlAttributes } from '../api/models/NewScrapedSql';
import { ScrapingIndexSql, scrapingIndexSqlAttributes } from '../api/models/ScrapingIndexSql';
import { scrapingUrlSqlAttributes, ScrapingUrlsSql } from '../api/models/ScrapingUrlSql';
